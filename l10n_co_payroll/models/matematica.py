...
def partir_dia(intervalos):
    ...
    for intervalo in intervalos:
        ...
        # Para el intervalo final, el dia estaba terminando en el segundo 86398 pero debe terminar en el segundo 86399
        if dic_intervalo_laboral['hasta'].seconds == 86398:
            dic_intervalo_laboral['hasta'] += timedelta(seconds=1)
