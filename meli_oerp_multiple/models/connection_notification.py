                ...
                try:
                    if ("_id" in n):
                        ...
                        if (n["topic"] in ["order","created_orders","orders_v2"]):
                            ...
                            if (noti):
                                _logger.info("Procesando Last Meli Order Notification: ["+str(account and account.name)+"] "+str(resource))
                        ...
                        if (n["topic"] in ["questions"]):
                            if (noti):
                                _logger.info("Procesando Last Meli Question Notification: "+str(resource))
