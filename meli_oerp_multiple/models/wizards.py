...
class product_template_import(models.TransientModel):
    ...
    def check_sync_status( self, context=None, config=None, meli=None ):
        ...
        #_logger.info("check last import Status: "+str(self and self.id))
        ...
        #_logger.info("check last import Status: attachments "+str(attachments))
        #_logger.info("check last import Status: report_import_link "+str(report_import_link))
